...
namespace Casgem_DataAccessLayer.Migrations
{
    ...
    [Migration("20230813093035_initial-migrate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Casgem_EntityLayer.Entities.Concrete.CompanyUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Casgem_EntityLayer.Entities.Concrete.CompanyUser", b =>
                {
                    ...
                    b.HasOne("Casgem_EntityLayer.Entities.Concrete.User", "Users")
                        .WithMany("CompanyUser")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Casgem_EntityLayer.Entities.Concrete.WorkExperience", null)
                        .WithMany("CompanyUser")
